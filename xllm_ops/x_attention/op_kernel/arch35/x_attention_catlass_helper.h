...
// XA(x_attention) 自定义 catlass 模板注册点：定义 EpilogueAscend950XACombineScale 等
// dispatch-policy 与 block 特化，须在 catlass 聚合头之后 include（上面三个 kernel 已引入聚合头）
#include "catlass_patch/xa_register.hpp"
