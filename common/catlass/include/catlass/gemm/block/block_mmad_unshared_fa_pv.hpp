...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2UnsharedFAPV;
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        l1BTensor = resource.l1Buf.template GetBufferByByte<ElementB>(l1BufAddrStart + L1A_SIZE);
    ...
    void operator()(
        ...
        GemmCoord actualShape, Arch::CrossCoreFlag softmaxReady)
    {
        ...
        tileMmad(l0CTensor, l0ATensor, l0BTensor, mRound, nRound, actualShape.k());
