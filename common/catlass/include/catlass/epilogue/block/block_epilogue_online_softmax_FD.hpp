...
#ifndef CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_FD_HPP
#define CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_FD_HPP
...
template <
    ...
    LseMode LSE_MODE_>
class BlockEpilogue<
    EpilogueAtlasA2OnlineSoftmax_FD<LSE_MODE_>,
    OutputType_,
    InputType_,
    MaskType_>
{
public:
    using DispatchPolicy = EpilogueAtlasA2OnlineSoftmax_FD<LSE_MODE_>;
...
template <
    ...
    LseMode LSE_MODE_>
class BlockEpilogue<
    EpilogueAscend950OnlineSoftmax_FD<LSE_MODE_>,
    OutputType_,
    InputType_,
    MaskType_>
    : public BlockEpilogue<EpilogueAtlasA2OnlineSoftmax_FD<LSE_MODE_>, OutputType_, InputType_, MaskType_> {
public:
    using Base = BlockEpilogue<EpilogueAtlasA2OnlineSoftmax_FD<LSE_MODE_>, OutputType_, InputType_, MaskType_>;
    using DispatchPolicy = EpilogueAscend950OnlineSoftmax_FD<LSE_MODE_>;
    using ArchTag = typename DispatchPolicy::ArchTag;
    using Base::Base;
};
}

#endif  // CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_FD_HPP