...
#ifndef CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_HPP
#define CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_HPP
...
template <
    ...
    LseMode LSE_MODE_>
class BlockEpilogue<
    EpilogueAtlasA2XFAIOnlineSoftmax<LSE_MODE_>,
    OutputType_,
    InputType_,
    MaskType_>
{
public:
    using DispatchPolicy = EpilogueAtlasA2XFAIOnlineSoftmax<LSE_MODE_>;
...
#endif  // CATLASS_EPILOGUE_BLOCK_BLOCK_EPILOGUE_ONLINE_SOFTMAX_HPP